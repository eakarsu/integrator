...
// Batch 10 frontend page: "AI for replay-and-fix on failed flows" (ai-gap) — integrator
import React, { useEffect, useState } from 'react';

const SLUG = "ai-for-replay-and-fix-on";
const LABEL = "AI for replay-and-fix on failed flows";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-ai-for-replay-and-fix-on";

export default function GapAiForReplayAndFixOn() {
