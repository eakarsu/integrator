...
// Batch 10 frontend page: "No tenant isolation" (nonai-gap) — integrator
import React, { useEffect, useState } from 'react';

const SLUG = "no-tenant-isolation";
const LABEL = "No tenant isolation";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-tenant-isolation";

export default function GapNoTenantIsolation() {
