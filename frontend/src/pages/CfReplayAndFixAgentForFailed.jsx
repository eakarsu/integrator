...
// Batch 10 frontend page: "Replay-and-fix agent for failed runs (proposes patch + re-runs)" (cfs) — integrator
import React, { useEffect, useState } from 'react';

const SLUG = "replay-and-fix-agent-for-failed";
const LABEL = "Replay-and-fix agent for failed runs (proposes patch + re-runs)";
const SECTION = "cfs";
const API_PATH = "/api/cf-replay-and-fix-agent-for-failed";

export default function CfReplayAndFixAgentForFailed() {
